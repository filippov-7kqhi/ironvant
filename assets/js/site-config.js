/* ---------------------------------------------------------------------------
   Runtime configuration for IronVant. Edited through /admin.html, or by hand.
...
window.SITE_CONFIG = {
  ...
  business: {
    ...
    companyNo: "",
    vatNo:     "",
    street:    "34-40 Belgrave Road",
    city:      "London",
    postcode:  "",
    phone:     "+44 20 7834 1379"
  },
  ...
  analyticsEndpoint: "https://ironvant-collector.stellapark1141.workers.dev",

  // Optional: Checkout Sessions for baskets with more than one machine.
  checkoutEndpoint: "https://ironvant-collector.stellapark1141.workers.dev/checkout",
