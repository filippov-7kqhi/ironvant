# Payments and the Worker: IronVant

## How ironvant.shop takes payment
...
`GET /stats` returns them, stored in the KV namespace `ironvant-EVENTS`.

- Worker: `https://ironvant-collector.stellapark1141.workers.dev`
...
needed: without it the script refuses a key whose account name is not IronVant.
...
& {
  ...
  Set-Location "C:\Users\Hp\uk-stores\ironvant\stripe"
...
- delete the KV namespace `ironvant-EVENTS`. It holds the dashboard's data.
